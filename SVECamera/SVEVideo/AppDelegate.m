...
//    BOOL hasShowedIntroduce = [SWIntroduceViewController hasShowedIntroduce];
//    if (hasShowedIntroduce) {
//        //如果已经展示过引导页，就直接初始化各个系统
//        [self initAllSys];
//    }else{
//        //没有展示过引导页，就展示引导页
//        SWIntroduceViewController *introduceVC = [[SWIntroduceViewController alloc] init];
//        introduceVC.delegate = self;
//        [introduceVC setIntroduceType:INTRODUCE_TYPE_IMAGE];
