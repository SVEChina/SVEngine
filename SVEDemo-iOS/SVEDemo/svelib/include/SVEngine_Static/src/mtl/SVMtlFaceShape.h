...
namespace sv {
    ...
    namespace mtl{
        ...
        protected:
            ...
            GLint m_uni_loaction0;
            GLint m_uni_loaction1;
            GLint m_uni_loaction2;
            GLint m_uni_loaction3;
            GLint m_uni_loaction4;
            GLint m_uni_loaction5;
            GLint m_uni_loaction6;
            GLint m_uni_loaction7;
            GLint m_uni_loaction8;
            GLint m_uni_loaction9;
            GLint m_uni_loaction10;
            GLint m_uni_loaction11;
            GLint m_uni_eyelarge;
            GLint m_uni_faceslim;
        };
