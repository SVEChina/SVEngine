...
#ifndef SV_CORE_LIST_H
#define SV_CORE_LIST_H

#include "SVTypes.h"
#include "SVCoreAllocator.h"
...
//! Doubly linked list template.
    ...
    public:
        ...
        public:
            ...
            SKListNode* getCurrent(){ return Current; }
        ...
        */
        ...
        void swap(list<T> &other) {
            swapNative(First, other.First);
            swapNative(Last, other.Last);
            swapNative(Size, other.Size);
            swapNative(allocator,
    ...
    private:
        ...
        SKListNode *Last;
        u32 Size;
        SVCoreAllocator<SKListNode> allocator;
