...
#ifndef SV_CORE_MATH_H
#define SV_CORE_MATH_H
...
#if defined(_SV_SOLARIS_PLATFORM_) || defined(__BORLANDC__) || defined (__BCPLUSPLUS__) || defined (_WIN32_WCE)
...
#undef PI64
    ...
    */
    ...
    // avoid ambiguity when swapping objects of an SVENGINE type that has not
