...
void SVPenStroke::_createGlowMesh(){
    ...
    m_pGlowMesh->setVertexType(E_VF_V3_C_INS);
    ...
    t_pVertexData->resize(36*sizeof(V3));
    t_pVertexData->writeData(t_ver, 36*sizeof(V3));
    m_pGlowMesh->setVertex3Data(t_pVertexData);
    m_pGlowMesh->setVertexDataNum(36);
    SVDataSwapPtr t_pColorData = MakeSharedPtr<SVDataSwap>();
    t_pColorData->resize(36*sizeof(C));
    t_pColorData->writeData(t_color, 36*sizeof(C));
...
void SVPenStroke::_createStrokeMesh() {
    ...
    m_pBoxMesh->setVertexDataNum(36);
    SVDataSwapPtr t_pColorData = MakeSharedPtr<SVDataSwap>();
    t_pColorData->resize(36*sizeof(C));
    t_pColorData->writeData(t_color, 36*sizeof(C));
