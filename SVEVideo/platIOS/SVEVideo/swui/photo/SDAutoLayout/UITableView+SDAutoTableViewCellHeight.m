...
- (void)registerCellWithCellClass:(Class)cellClass
{
    ...
    {
        NSString *path =
            [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"%@.nib", NSStringFromClass(cellClass)]
                                            ofType:nil];
        if (path)
        {
            self.modelCell = nil;
...
- (NSDictionary *)heightCacheDict { return _cacheDictionary; }
...
- (CGFloat)cellHeightForIndexPath:(NSIndexPath *)indexPath
             ...
             cellContentViewWidth:(CGFloat)width
                  cellDataSetting:(AutoCellHeightDataSettingBlock)cellDataSetting
{
...
- (SDCellAutoHeightManager *)cellAutoHeightManager { return objc_getAssociatedObject(self, _cmd); }
...
- (AutoCellHeightDataSettingBlock)cellDataSetting { return self.cellAutoHeightManager.cellDataSetting; }
@end
